 ...
 */
public class CatalinaClassLoaderBackup extends WebappClassLoaderBase{
	
    private static final int EOF = -1;
    
    private static final int DEFAULT_BUFFER_SIZE = 1024 * 4;
	
    private static final org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory.getLog( CatalinaClassLoaderBackup.class );
	
	private String signSuffix = ".classx";
	
	private SimpleCipher cipher = new SimpleCipher("10893ecbdfa7dc6404d6b9f7835bc22661c8d02968aeb9c8");
	
	public CatalinaClassLoaderBackup(){
		super();
	}
	
	public CatalinaClassLoaderBackup(ClassLoader parent){
		super(parent);
	}
	...
	private void doDecode(ResourceEntry entry) throws IOException{
		...
		entry.binaryContent = cipher.decodeBytes(entry.binaryContent);
	}
	...
	public CatalinaClassLoaderBackup copyWithoutTransformers() {
		CatalinaClassLoaderBackup result = new CatalinaClassLoaderBackup(getParent());
