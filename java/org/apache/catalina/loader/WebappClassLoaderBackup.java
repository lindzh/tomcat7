...
public class WebappClassLoaderBackup extends WebappClassLoaderBase {
    
    public WebappClassLoaderBackup() {
        super();
    }


    public WebappClassLoaderBackup(ClassLoader parent) {
        super(parent);
    }
     ...
     */
    @Override
    public WebappClassLoaderBackup copyWithoutTransformers() {

        WebappClassLoaderBackup result = new WebappClassLoaderBackup(getParent());
